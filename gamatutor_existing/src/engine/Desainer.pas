...
uses
  ...
  ToolWin,ClipBrd,Buttons,primitif,jpeg, OleCtnrs, ExtDlgs, System.ImageList,
  System.Actions;
...
begin
 ...
 {*write setting file if double click the ANM file for editing* -- update 07-10-2015}
   if (ParamCount = 1) then
   begin
    fileop1.OpenFileAnimasi(progressbar1,paramstr(1),listframe);
    count:=0;
    selectframe(count);

    fileop1.ExtractFile(paramstr(1),Filename);
 ...
 {*************Inisialisasi Editor Teks*******************}
  ...
  if (ParamCount = 0) then   {*********update 17-10-2015****************}
  begin
...
begin
   //setwindowlong(mainform.Handle,GWL_EXSTYLE,getwindowlong(mainform.Handle,GWL_EXSTYLE) or WS_EX_TOPMOST);
