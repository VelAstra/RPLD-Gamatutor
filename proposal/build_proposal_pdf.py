...
figures_dir = os.path.join(proposal_dir, "figures")
...
<body>
  ...
  <div class="page">
    ...
    <div class="page-content cover-container">
      <div>
        ...
        <p style="text-align: center; font-size: 9.5pt; color: #475569; font-weight: 600; max-width: 85%; margin: 0 auto 15px auto;">
      ...
      <div style="background: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 12px; padding: 12px 18px; text-align: left; margin: 10px 0;">
        <div style="font-weight: 800; font-size: 9.5pt; color: #1e3a8a; margin-bottom: 4px; border-bottom: 1px solid #cbd5e1; padding-bottom: 3px;">
          RINGKASAN EKSEKUTIF (EXECUTIVE SUMMARY)
        </div>
        <p style="font-size: 8.2pt; line-height: 1.42; margin-bottom: 6px;">
        ...
        <p style="font-size: 8.2pt; line-height: 1.42; margin-bottom: 0;">
          Proposal ini merumuskan perancangan ulang secara menyeluruh (<em>remake</em>) terhadap Gamatutor menggunakan <strong>Figma Design Thinking Framework</strong> (Empathize, Define, Ideate, Prototype, Test). Gamatutor ditransformasikan menjadi platform modern berbasis Web/Cloud yang dilengkapi: (1) Canvas Studio drag-and-drop no-code, (2) AI Script-to-Animation berbasis dekomposisi metakognitif, (3) Gamifikasi Protégé SkillQuest, (4) Format interoperabel terbuka <code>.gtut</code> (JSON) bebas Flash, serta (5) Hub Komunitas partisipatif untuk menggerakkan kampanye sosial nasional belajar keahlian baru secara masif.
        </p>
      </div>
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 2: BAB I - EMPATHIZE (RISET PENGGUNA) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <h3 class="section-title">1.2 Metodologi Riset Empati Pengguna</h3>
      <p>
        Dalam mengidentifikasi akar permasalahan, tim penyusun melakukan riset empati komprehensif terhadap <strong>45 calon pengguna</strong> di wilayah D.I. Yogyakarta dan sekitarnya. Riset mencakup survei kualitatif, wawancara mendalam (*in-depth interviews*), serta observasi kontekstual terhadap 3 segmen demografis utama:
      </p>
      <ul>
        <li><strong>Mahasiswa & Pelajar Vokasi/Teknik (55%):</strong> Kesulitan memahami sintaks teknis yang abstrak (misal perintah terminal Git, konfigurasi Docker, instalasi database) dan merasa video tutorial terlalu cepat atau sulit diulang per langkah.</li>
        <li><strong>Pencari Kerja & Career Switchers (25%):</strong> Membutuhkan visualisasi konkret alur kerja perangkat lunak industri (misal spreadsheet Excel tingkat lanjut, perancangan Figma, tools akuntansi), namun tidak memiliki tempat bertanya ketika instruktur video melewati detail penting.</li>
        <li><strong>Dosen, Guru, & Edukator Konten (20%):</strong> Membutuhkan media pembelajaran modular yang mudah direvisi. Mereka sangat terbebani oleh tingginya usaha (*effort*) membuat video konvensional—jika terjadi satu salah klik, seluruh video harus direkam dan diedit ulang.</li>
      </ul>

      <div class="warning-card">
        <strong>Temuan Kunci Riset Empati:</strong> 82.2% responden menyatakan jenuh dengan video berdurasi panjang (>15 menit). 73.3% responden ingin membuat tutorial sendiri untuk memvalidasi pemahamannya, tetapi <strong>mundur teratur karena hambatan teknis</strong>: tidak bisa mengedit video, laptop berspesifikasi rendah (*laggy* saat rendering MP4), dan malu menampilkan wajah/suara aslinya.
      </div>

      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig1_design_thinking_framework.png" alt="Framework Design Thinking">
      ...
      <h3 class="section-title">1.3 Analisis Hambatan Kognitif Pembelajar</h3>
      <p>
        Observasi lapangan membuktikan bahwa menonton video tutorial bersifat <em>passive consumption</em>. Otak hanya mengaktifkan memori jangka pendek tanpa membentuk asosiasi skema pengetahuan yang kokoh. Sebaliknya, ketika seseorang diposisikan sebagai pembuat materi (pengajar), ia harus menyeleksi informasi esensial, menentukan urutan hierarki logika, dan mengantisipasi titik kebingungan audiens. Di sinilah letak urgensi penyediaan perangkat lunak yang mereduksi friksi teknis pembuatan tutorial animatif.
      </p>
    </div>

    <div class="footer-bar">
      <span>Bagian 1: Empathize & User Research</span>
      <span>Halaman 2</span>
    </div>
  </div>

  <!-- =================================================================== -->
  <!-- HALAMAN 3: BAB I - EMPATHIZE (LANDASAN TEORETIS & AUDIT REPO) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <p>
        Pengembangan Gamatutor Next-Gen diperkuat oleh landasan teoretis artikel Medium berjudul <em>"Why Creating Tutorials is the Best Way to Learn New Skills"</em> yang ditulis oleh Claire Focus (2025). Artikel tersebut menggarisbawahi beberapa prinsip pedagogis transformatif:
      </p>
      ...
      <p>
        Secara neurologis, ini sejalan dengan <strong>Dual Coding Theory (Paivio)</strong> dan <strong>Cognitive Load Theory (Sweller)</strong>. Format animasi modular yang memadukan pointer kursor terarah, sorotan visual (*spotlight*), dan balon teks ringkas berhasil meminimalkan <em>extraneous cognitive load</em>, sehingga kapasitas kerja memori terfokus penuh pada asimilasi konsep esensial.
      </p>

      <h3 class="section-title">1.5 Eksplorasi & Audit Repositori Gamatutor Eksisting</h3>
      <p>
        Tim melakukan audit teknis terhadap repositori open-source <strong>Gamatutor</strong> (Gama Animation Engine - GAE) yang diakses pada <code>https://github.com/gamatutor/gamatutor</code>. Repositori ini dikembangkan oleh akademisi Universitas Gadjah Mada (Lukman H. et al.) dan memuat modul mesin animasi serta tutorial player. Temuan audit mendalam menghasilkan beberapa evaluasi kritis:
      </p>
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 4: BAB II - DEFINE (EMPATHY MAP & USER PERSONAS) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <p>
        Data wawancara dan observasi dari tahap Empathize disintesis ke dalam diagram <strong>Empathy Map</strong> untuk menangkap pola pikir, kecemasan, dan aspirasi terdalam calon pengguna.
      </p>

      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig2_empathy_map.png" alt="Empathy Map Calon Pengguna">
      ...
      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig3_user_personas.png" alt="3 User Personas">
        <div class="figure-caption">Gambar 2.2: Profil Tiga Persona Target Pengguna Gamatutor Next-Gen.</div>
      </div>

      <p style="font-size: 8.2pt;">
        <strong>1. Rian Pratama (21 th, Mahasiswa Informatika):</strong> Mahir logika pemrograman namun kerap terjebak kebingungan saat menghubungkan tool infrastruktur. Butuh sarana berbagi tutorial baris perintah (*terminal workflow*) yang ringkas dan bisa dipamerkan di portofolio GitHub atau LinkedIn.<br>
        <strong>2. Siti Rahma (25 th, Career Switcher):</strong> Berlatar belakang non-teknis, mempelajari tools spreadsheet Excel dan UI/UX Figma. Menginginkan tutorial yang menyediakan <em>checkpoint latihan interaktif</em> agar ia dapat mengeklik tombol target di layar secara mandiri.<br>
        <strong>3. Budi Santoso (34 th, Instruktur Vokasi):</strong> Membina ratusan siswa kejuruan. Membutuhkan efisiensi waktu pembuatan materi ajar tanpa harus mengulang rekaman dari menit awal hanya karena salah menekan shortcut keyboard.
      </p>
    </div>
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 5: BAB II - DEFINE (PROBLEM STATEMENTS & GAP ANALYSIS) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 6: BAB III - IDEATE (BRAINSTORMING & ARSITEKTUR ULANG) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <p>
        Salah satu inovasi puncak usulan ini adalah integrasi modul <strong>AI Script-to-Animation</strong>. Fitur ini diilhami langsung oleh riset terkini di Universitas Gadjah Mada mengenai <em>Generative AI Metacognitive Tutor</em> (Prof. Ridi Ferdiana et al., 2025).
      </p>
      ...
      <p>
        Inovasi ini menurunkan hambatan psikologis *blank page syndrome* secara dramatis. Pengguna tidak lagi bingung harus memulai tutorialnya dari mana.
      </p>
    </div>
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 7: BAB III - IDEATE (FITUR KUNCI & MATRIKS PRIORITAS) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <p>
        Gamatutor Next-Gen mengusung 5 fitur pilar yang dirancang khusus untuk memicu partisipasi aktif pembelajar lintas bidang ilmu:
      </p>
      <ol>
        <li><strong>Studio Editor No-Code (Visual Canvas):</strong> Kanvas visual WYSIWYG dengan fitur drag-and-drop kursor mouse, kotak sorotan (*focus spotlight*), balon dialog penjelasan, serta pengatur durasi per langkah.</li>
        <li><strong>AI Script-to-Animation Assistant:</strong> Modul pintar yang mengubah teks deskripsi keterampilan baru menjadi alur animasi langkah demi langkah secara otomatis.</li>
        <li><strong>Interactive Active Recall Player:</strong> Player edukatif dengan mode latihan langsung. Animasi dapat diatur untuk "berhenti" pada langkah krusial, menuntut pembelajar mengeklik sasaran yang benar di layar sebelum animasi berlanjut.</li>
        <li><strong>Gamatutor Community Hub & Remix Engine:</strong> Galeri tutorial publik yang dilengkapi fitur <strong>"Fork & Remix"</strong> (terinspirasi dari konsep GitHub). Pembelajar dapat mengkloning tutorial orang lain untuk disesuaikan atau dikembangkan lebih lanjut.</li>
        <li><strong>Gamifikasi Edukatif (SkillQuest & Protégé Rewards):</strong> Sistem penghargaan berbasis poin pengalaman (XP), streak harian, lencana penghargaan (*badges* seperti "Feynman Initiate", "Signpost Creator"), dan papan peringkat nasional.</li>
      </ol>

      <h3 class="section-title">3.5 Prioritisasi Ide: Matriks Impact vs. Effort</h3>
      <p>
        Untuk menjamin kelayakan implementasi teknik dalam batas waktu dan sumber daya yang terukur, seluruh ide fitur dipetakan ke dalam <strong>Matriks Impact vs. Effort</strong> (2x2):
      </p>

      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig4_impact_effort_matrix.png" alt="Matriks Impact vs Effort">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 8: BAB IV - PROTOTYPE (ARSITEKTUR & WORKFLOW) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig5_system_architecture.png" alt="Arsitektur Sistem">
      ...
      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig6_user_flow.png" alt="User Flow Diagram">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 9: BAB IV - PROTOTYPE (SHOWCASE PURWARUPA VISUAL) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig8_prototype_showcase.png" alt="Showcase High-Fidelity Prototype">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 10: BAB V - TEST (SKENARIO PENGUJIAN USABILITAS) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 11: BAB V - TEST (METRIK EVALUASI KUANTITATIF & KUALITATIF) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <div class="figure-container">
        <img src="file:///{figures_dir.replace(os.sep, '/')}/fig7_usability_metrics.png" alt="Grafik Metrik Evaluasi">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 12: BAB V - TEST (FEEDBACK LOOP & ROADMAP GERAKAN) -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
  ...
  <!-- =================================================================== -->
  <!-- HALAMAN 13: DAFTAR PUSTAKA & LAMPIRAN -->
  <!-- =================================================================== -->
  <div class="page">
    <div class="header-bar">
    ...
    <div class="page-content">
      ...
      <ol style="font-size: 8pt; line-height: 1.45;">
      ...
      <h3 class="section-title" style="margin-top: 14px;">Lampiran Luaran Proyek (Deliverables Summary)</h3>
      <table class="data-table">
        <thead>
          <tr>
        ...
        <tbody>
          <tr>
            ...
            <td><code>KS RPLD/proposal/Proposal_Pengembangan_Gamatutor.pdf</code> (13 halaman, format ilmiah-populer, memuat 5 tahapan Design Thinking lengkap).</td>
            <td><strong style="color: #166534;">Selesai 100% (Terverifikasi)</strong></td>
          </tr>
          <tr>
            <td><strong>Dokumen Naskah Markdown</strong></td>
            <td><code>KS RPLD/proposal/Proposal_Pengembangan_Gamatutor.md</code> (dokumentasi naskah komprehensif untuk telaah teks daring).</td>
          ...
          <tr>
            ...
            <td><code>KS RPLD/proposal/figures/</code> (8 diagram visual beresolusi tinggi 300 DPI mencakup arsitektur, user flow, persona, matriks, dan antarmuka).</td>
            <td><strong style="color: #166534;">Selesai 100%</strong></td>
          </tr>
          <tr>
      ...
      <div class="feynman-card" style="margin-top: 12px; font-size: 8pt; text-align: center;">
