...
\subsection{Riset Pengguna \& Validasi Empiris (N = 20 Responden)}
Tim menyebarkan instrumen kuesioner terstruktur daring terhadap 20 calon pengguna representatif (90.0\% Mahasiswa, 5.0\% Tutor/Asisten Lab, dan 5.0\% Content Creator) yang mempelajari Pemrograman (65\%), Desain Grafis (65\%), dan Olah Data (65\%). Temuan utama membuktikan:
\begin{enumerate}
  \item \textbf{Validasi Patologis Tutorial Hell:} Sebanyak 90.0\% responden mengalami kebuntuan saat mempraktikkan mandiri video tutorial (rerata 3.60/5.00), diperparah sifat video yang pasif (45\%) dan boros kuota/penyimpanan (40\%).
  \item \textbf{Hambatan Pembuatan Tutorial:} Sebanyak 60.0\% responden pernah berniat membuat tutorial sendiri, namun 100\% membatalkannya karena repot mengedit video (80.0\%), bingung menyusun materi (65.0\%), dan faktor psikologis/kurang percaya diri (55.0\%).
  \item \textbf{Preferensi Fitur:} Permintaan tertinggi terpusat pada Mode Latihan Aktif (65.0\%), Gamifikasi (65.0\%), dan Asisten AI Script-to-Animation (55.0\%).
  \item \textbf{Peluang Adopsi:} 95.0\% belum mengenal GAE lama, dengan 80.0\% menyatakan butuh aplikasi pembuat tutorial animatif dan 85.0\% siap mencoba.
\end{enumerate}
